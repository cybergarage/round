...
#define round_json_rpc_setresult(obj, value) round_json_map_setobject(obj, ROUNDC_JSON_RPC_RESULT, value)
...
#define round_json_rpc_getresult(obj, value) round_json_map_getobject(obj, ROUNDC_JSON_RPC_RESULT, value)
#define round_json_rpc_geterror(obj, value) round_json_map_getobject(obj, ROUNDC_JSON_RPC_ERROR, value)
