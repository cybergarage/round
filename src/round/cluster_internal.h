...
#define round_cluster_getequalnode(cluster,node) round_node_ring_getequalnode(cluster->nodeRing,node)
#define round_cluster_hasequalnode(cluster,node) round_node_ring_hasequalnode(cluster->nodeRing,node)
