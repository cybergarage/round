...
/*
ssize_t round_base64_encode(const byte *inBytes, size_t rawByteLen, std::string
*encodedStr)
{
 ...
 ****************************************/
/*
ssize_t round_base64_decode(const std::string &encodedStr, byte
**decordedBytes);
ssize_t Round::Base64::Decode(const std::string &encodedStr, byte
**decordedBytes) {
