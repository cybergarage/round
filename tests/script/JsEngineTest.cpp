...
{
  static const char* SETKEY_CODE = "function " RPC_METHOD_SET_KEY_NAME "(params) {return " ROUND_SYSTEM_METHOD_SET_REGISTRY "(params);}";
  static const char* GETKEY_CODE = "function " RPC_METHOD_GET_KEY_NAME "(params) {return " ROUND_SYSTEM_METHOD_GET_REGISTRY "(params);}";
  static const char* REMOVEKEY_CODE = "function " RPC_METHOD_REMOVE_KEY_NAME "(params) {return " ROUND_SYSTEM_METHOD_REMOVE_REGISTRY "(params);}";
