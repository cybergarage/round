...
BOOST_AUTO_TEST_CASE(MethodManagerNew)
{
  ...
  BOOST_CHECK_EQUAL(ROUND_TEST_MAP_SIZE, round_method_manager_getmethodsize(mgr));
  BOOST_CHECK_EQUAL(ROUND_TEST_MAP_SIZE, round_method_manager_getenginsize(mgr));
