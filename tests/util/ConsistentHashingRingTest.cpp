...
bool
round_test_consistenthashing_node_delete(RoundTestConsistentHashingNode *node) {
  if (!node)
    return false;
...
BOOST_AUTO_TEST_CASE(ConsistentHashGraphAddSameNodeTest) {
  ...
  RoundTestConsistentHashingNode *node =
  round_test_consistenthashing_node_new(0);
...
BOOST_AUTO_TEST_CASE(ConsistentHashGraphCompareTest) {
  ...
  RoundTestConsistentHashingNode *node2 = nodes[0] =
  round_test_consistenthashing_node_new(2);
  RoundTestConsistentHashingNode *node4 = nodes[1] =
  round_test_consistenthashing_node_new(4);
  RoundTestConsistentHashingNode *node6 = nodes[2] =
  round_test_consistenthashing_node_new(6);
  RoundTestConsistentHashingNode *node8 = nodes[3] =
  round_test_consistenthashing_node_new(8);
...
BOOST_AUTO_TEST_CASE(ConsistentHashGraphOffsetNodeTest) {
  ...
  for (int n = 0; n < conNodeCount; n++) {
    nodes[n] =
    (RoundConsistentHashingNode *)round_test_consistenthashing_node_new(n + 1);
    round_consistenthashing_ring_addnode(ring, nodes[n]);
  }
  ...
  for (int baseOffset = 0; baseOffset <= conNodeCount;
    ...
    for (int n = 1; n < conNodeCount; n++) {
      BOOST_CHECK_EQUAL(
      round_consistenthashing_ring_getprevnode(ring, nodes[n]), nodes[n - 1]);
      BOOST_CHECK_EQUAL(round_consistenthashing_ring_getoffsetnode(
                        ring, nodes[n], (-1 - baseOffset)),
                        nodes[n - 1]);
    }
...
BOOST_AUTO_TEST_CASE(ConsistentHashGraphFowardDistanceTest) {
  ...
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[0], nodes[0]),
  0);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[0], nodes[1]),
  1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[0], nodes[2]),
  2);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[0], nodes[3]),
  3);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[0], nodes[4]),
  4);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[0], nodes[5]),
  5);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[0], nodes[6]),
  6);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[0], nodes[7]),
  7);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[0], nodes[8]),
  8);

  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[1], nodes[0]),
  8);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[1], nodes[1]),
  0);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[1], nodes[2]),
  1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[1], nodes[3]),
  2);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[1], nodes[4]),
  3);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[1], nodes[5]),
  4);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[1], nodes[6]),
  5);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[1], nodes[7]),
  6);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[1], nodes[8]),
  7);

  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[2], nodes[0]),
  7);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[2], nodes[1]),
  8);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[2], nodes[2]),
  0);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[2], nodes[3]),
  1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[2], nodes[4]),
  2);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[2], nodes[5]),
  3);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[2], nodes[6]),
  4);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[2], nodes[7]),
  5);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[2], nodes[8]),
  6);

  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[3], nodes[0]),
  6);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[3], nodes[1]),
  7);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[3], nodes[2]),
  8);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[3], nodes[3]),
  0);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[3], nodes[4]),
  1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[3], nodes[5]),
  2);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[3], nodes[6]),
  3);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[3], nodes[7]),
  4);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[3], nodes[8]),
  5);

  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[4], nodes[0]),
  5);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[4], nodes[1]),
  6);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[4], nodes[2]),
  7);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[4], nodes[3]),
  8);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[4], nodes[4]),
  0);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[4], nodes[5]),
  1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[4], nodes[6]),
  2);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[4], nodes[7]),
  3);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[4], nodes[8]),
  4);

  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[5], nodes[0]),
  4);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[5], nodes[1]),
  5);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[5], nodes[2]),
  6);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[5], nodes[3]),
  7);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[5], nodes[4]),
  8);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[5], nodes[5]),
  0);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[5], nodes[6]),
  1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[5], nodes[7]),
  2);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[5], nodes[8]),
  3);

  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[6], nodes[0]),
  3);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[6], nodes[1]),
  4);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[6], nodes[2]),
  5);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[6], nodes[3]),
  6);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[6], nodes[4]),
  7);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[6], nodes[5]),
  8);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[6], nodes[6]),
  0);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[6], nodes[7]),
  1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[6], nodes[8]),
  2);

  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[7], nodes[0]),
  2);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[7], nodes[1]),
  3);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[7], nodes[2]),
  4);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[7], nodes[3]),
  5);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[7], nodes[4]),
  6);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[7], nodes[5]),
  7);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[7], nodes[6]),
  8);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[7], nodes[7]),
  0);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[7], nodes[8]),
  1);

  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[8], nodes[0]),
  1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[8], nodes[1]),
  2);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[8], nodes[2]),
  3);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[8], nodes[3]),
  4);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[8], nodes[4]),
  5);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[8], nodes[5]),
  6);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[8], nodes[6]),
  7);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[8], nodes[7]),
  8);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getforwardnodedistance(ring, nodes[8], nodes[8]),
  0);
...
BOOST_AUTO_TEST_CASE(ConsistentHashGraphMinDistanceTest) {
  ...
  for (int i = 0; i < conNodeCount; i++) {
    for (int j = 0; j < conNodeCount; j++) {
      off_t distance =
      round_consistenthashing_ring_getminnodedistance(ring, nodes[i], nodes[j]);
      BOOST_CHECK(distance <= (conNodeCount / 2));
    }
  }

  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[0], nodes[0]), 0);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[0], nodes[1]), 1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[0], nodes[2]), 2);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[0], nodes[3]), 3);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[0], nodes[4]), 4);
  BOOST_CHECK_EQUAL(
  ...
  -1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[1], nodes[1]), 0);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[1], nodes[2]), 1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[1], nodes[3]), 2);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[1], nodes[4]), 3);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[1], nodes[5]), 4);
  BOOST_CHECK_EQUAL(
  ...
  -1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[2], nodes[2]), 0);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[2], nodes[3]), 1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[2], nodes[4]), 2);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[2], nodes[5]), 3);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[2], nodes[6]), 4);
  BOOST_CHECK_EQUAL(
  ...
  -1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[3], nodes[3]), 0);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[3], nodes[4]), 1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[3], nodes[5]), 2);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[3], nodes[6]), 3);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[3], nodes[7]), 4);
  BOOST_CHECK_EQUAL(
  ...
  -1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[4], nodes[4]), 0);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[4], nodes[5]), 1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[4], nodes[6]), 2);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[4], nodes[7]), 3);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[4], nodes[8]), 4);

  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[5], nodes[0]), 4);
  BOOST_CHECK_EQUAL(
  ...
  -1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[5], nodes[5]), 0);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[5], nodes[6]), 1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[5], nodes[7]), 2);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[5], nodes[8]), 3);

  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[6], nodes[0]), 3);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[6], nodes[1]), 4);
  BOOST_CHECK_EQUAL(
  ...
  -1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[6], nodes[6]), 0);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[6], nodes[7]), 1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[6], nodes[8]), 2);

  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[7], nodes[0]), 2);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[7], nodes[1]), 3);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[7], nodes[2]), 4);
  BOOST_CHECK_EQUAL(
  ...
  -1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[7], nodes[7]), 0);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[7], nodes[8]), 1);

  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[8], nodes[0]), 1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[8], nodes[1]), 2);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[8], nodes[2]), 3);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[8], nodes[3]), 4);
  BOOST_CHECK_EQUAL(
  ...
  -1);
  BOOST_CHECK_EQUAL(
  round_consistenthashing_ring_getminnodedistance(ring, nodes[8], nodes[8]), 0);
